...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ isVisible }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center z-[9999] transition-opacity duration-500">
