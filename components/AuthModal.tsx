      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4 relative">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Sign in to save your analysis results and access premium features
          </p>
        </div>
        ...
        <div className="mb-6 space-y-3">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Save up to 50 analysis results</span>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-5 h-5 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
              <svg className="w-3 h-3 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Sync settings across devices</span>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-5 h-5 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
              <svg className="w-3 h-3 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Access paper trading system</span>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-5 h-5 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
              <svg className="w-3 h-3 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Premium AI insights</span>
          </div>
        </div>
