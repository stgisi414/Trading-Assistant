                ...
                <div className="relative z-10">
                    ...
                    {user ? (
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 rounded-lg transition-all duration-300 hover:scale-125 text-sm font-medium shadow-sm"
                        >
